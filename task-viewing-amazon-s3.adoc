...
.Étapes
. https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-creating-connectors-aws.html["Installer un connecteur"^] Dans le compte AWS où vous souhaitez afficher vos compartiments Amazon S3.
